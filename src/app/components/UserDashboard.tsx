...
export default function UserDashboard({
  ...
  let view: "dashboard" | "booking" | "wizard" = "dashboard";
  if (pathname.includes("/user/booking")) view = "booking";
  else if (pathname.includes("/user/wizard")) view = "wizard";
